...
public class ServerMain {
     ...
     * @see <a
     *     href="https://github.com/eclipse/lsp4j/blob/7fd8daebc61c1e8c83a0a3f016563e1896582db2/documentation/README.md#launch-and-connect-with-a-languageclient">Launch
     *     a language server</a>
     */
    ...
    private static Options getOptions() {
        ...
        options.addRequiredOption(
                ...
                OPT_FRAMEWORKPATH,
                true,
                "Absolute path of the Checker Framework");
        options.addRequiredOption(
                OPT_CHECKERS, OPT_CHECKERS, true, "List of checkers enabled for compilation");
        options.addOption(
                OPT_COMMANDLINEOPTIONS,
                OPT_COMMANDLINEOPTIONS,
                true,
                "List of command line options that gets passed in to javac");
        return options;
    }
